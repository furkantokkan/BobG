    ...
    public class AutoMoveAndRotate : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (rotateDegreesPerSecond.pingPong)
            {
                ...
                transform.parent.Rotate(pos,rotateDegreesPerSecond.space);
            }
            else
            {
                transform.parent.Rotate(rotateDegreesPerSecond.value * (deltaTime * rotateDegreesPerSecond.speed), rotateDegreesPerSecond.space);
            }
        }
        [Serializable]
